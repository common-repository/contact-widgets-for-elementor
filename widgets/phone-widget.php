...
/**
 * Elementor phone widget.
 *
 * Elementor widget that displays an phone icon, a headline and a text.
 *
 * @since 1.0.0
 */
class WEX_Phone_Widget extends \Elementor\Widget_Base
{
    /**
     * Get widget name.
     *
     * Retrieve phone widget name.
     *
    ...
    {
        return 'icon-box phone-widget';
    }
    
    /**
     * Get widget title.
     *
     * Retrieve phone widget title.
     *
    ...
    {
        return __( 'Phone', 'wpex-elementor-contact-widgets' );
    }
     ...
     *
     * Retrieve the list of categories the phone widget belongs to.
     *
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section( 'link_settings', [
            'label' => __( 'Phone Settings', 'wpex-elementor-contact-widgets' ),
        ] );
        ...
        $this->add_control( 'tel_num', $phone_tel_num );
        $this->end_controls_section();
