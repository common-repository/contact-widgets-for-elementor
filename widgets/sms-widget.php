 ...
 *
 * Elementor widget that displays an sms icon, a headline and a text.
 *
 * @since 1.0.0
 */
...
class WEX_Sms_Widget extends \Elementor\Widget_Base
{
    /**
     * Get widget name.
     *
     * Retrieve sms widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return 'icon-box sms-widget';
    }
    
    /**
     * Get widget title.
     *
     * Retrieve sms widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return __( 'SMS', 'wpex-elementor-contact-widgets' );
    }
    
    /**
     * Get widget icon.
     *
     * Retrieve sms widget icon.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return 'wpex-icon-sms-1';
    }
    
    /**
     * Get widget categories.
     *
     * Retrieve the list of categories the sms widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'selected_icon', [
            ...
            'default'          => [
            'value'   => 'wpex-icon-sms-1',
            'library' => 'wpex_icons',
        ],
            'recommended'      => [
            'wpex_icons' => [ 'wpex-icon-sms-1', 'wpex-icon-sms-2', 'wpex-icon-sms-3' ],
            'fa-solid'   => [
            'comment',
            'comment-o',
            'comments-o',
        ...
        $this->start_controls_section( 'link_settings', [
            'label' => __( 'SMS Settings', 'wpex-elementor-contact-widgets' ),
        ] );
        ...
        $sms_tel_num = [
            'label'       => __( 'Phone Number', 'wpex-elementor-contact-widgets' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'placeholder' => __( '0501234567', 'wpex-elementor-contact-widgets' ),
            'separator'   => 'before',
        ];
        $this->add_control( 'tel_num', $sms_tel_num );
        $this->add_control( 'text_message', [
            'label'       => __( 'message', 'wpex-elementor-contact-widgets' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'placeholder' => __( 'Your message...', 'wpex-elementor-contact-widgets' ),
            'separator'   => 'before',
            'dynamic'     => [
            'active' => true,
        ],
    ...
    private function build_sms_link( $settings )
    {
        ...
        if ( empty($settings['tel_num']) ) {
            return '';
        } elseif ( empty($settings['text_message']) && !empty($settings['tel_num']) ) {
            $value = 'sms:' . $settings['tel_num'];
            return $value;
        } elseif ( !empty($settings['text_message']) && !empty($settings['tel_num']) ) {
            $value = 'sms:' . $settings['tel_num'] . '?body=' . $settings['text_message'];
            return $value;
        }
