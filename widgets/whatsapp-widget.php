 ...
 *
 * Elementor widget that displays an whatsapp icon, a headline and a text.
 *
 * @since 1.0.0
 */
...
class WEX_Whatsapp_Widget extends \Elementor\Widget_Base
{
    /**
     * Get widget name.
     *
     * Retrieve whatsapp widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return 'icon-box whatsapp-widget';
    }
    
    /**
     * Get widget title.
     *
     * Retrieve whatsapp widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return __( 'Whatsapp', 'wpex-elementor-contact-widgets' );
    }
    
    /**
     * Get widget icon.
     *
     * Retrieve whatsapp widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the whatsapp widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register whatsapp widget controls.
     *
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section( 'link_settings', [
            'label' => __( 'Whatsapp Settings', 'wpex-elementor-contact-widgets' ),
        ] );
        ...
        $whats_whatsapp_num = [
            'label'       => __( 'Whatsapp Num', 'wpex-elementor-contact-widgets' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'placeholder' => __( '001501234567', 'wpex-elementor-contact-widgets' ),
            'separator'   => 'before',
        ];
        $this->add_control( 'whatsapp_num', $whats_whatsapp_num );
    ...
    {
        if ( empty($settings['whatsapp_num']) ) {
            return '';
        }
        return 'https://api.whatsapp.com/send?phone=' . $settings['whatsapp_num'] . '&text=' . $settings['text_message'];
    }
