 ...
 *
 * Elementor widget that displays an email icon, a headline and a text.
 *
 * @since 1.0.0
 */
...
class WEX_Email_Widget extends \Elementor\Widget_Base
{
    /**
     * Get widget name.
     *
     * Retrieve email widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return 'icon-box email-widget';
    }
    
    /**
     * Get widget title.
     *
     * Retrieve email widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    {
        return __( 'Email', 'wpex-elementor-contact-widgets' );
    }
    
    /**
     * Get widget icon.
     *
     * Retrieve phone widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the email widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register email widget controls.
     *
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section( 'link_settings', [
            'label' => __( 'Email Settings', 'wpex-elementor-contact-widgets' ),
        ] );
        ...
        $email_wpx_email = [
            'label'       => __( 'Email', 'wpex-elementor-contact-widgets' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'placeholder' => __( 'Your Email Address', 'wpex-elementor-contact-widgets' ),
            'separator'   => 'before',
        ];
        $this->add_control( 'wpx_email', $email_wpx_email );
        $email_wpx_subject = [
            'label'       => __( 'Subject', 'wpex-elementor-contact-widgets' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'placeholder' => __( 'Subject', 'wpex-elementor-contact-widgets' ),
            'separator'   => 'before',
        ];
        $this->add_control( 'wpx_subject', $email_wpx_subject );
        $email_wpx_message = [
            'label'       => __( 'Message', 'wpex-elementor-contact-widgets' ),
            'type'        => \Elementor\Controls_Manager::TEXTAREA,
            'placeholder' => __( 'Message', 'wpex-elementor-contact-widgets' ),
            'separator'   => 'before',
        ];
        $this->add_control( 'wpx_message', $email_wpx_message );
        $this->end_controls_section();
    ...
    {
        if ( empty($settings['wpx_email']) ) {
            return '';
        }
        $link = 'mailto:' . $settings['wpx_email'] . '?';
        $build_parts = [];
        if ( !empty($settings['wpx_subject']) ) {
            $build_parts['subject'] = $this->escape_space_in_url( $settings['wpx_subject'] );
        }
        if ( !empty($settings['wpx_message']) ) {
            $build_parts['body'] = $this->escape_space_in_url( $settings['wpx_message'] );
        }
